...
export function WelcomeTour() {
  ...
  // Safe client-side mount check to prevent hydration mismatch
  useEffect(() => {
  ...
  const stepsData = [
    {
      ...
      icon: <Shield size={32} className="text-primary animate-pulse" aria-hidden="true" />,
    ...
    },
    {
      ...
      icon: <Radar size={32} className="text-blue-500 rotate-animation" aria-hidden="true" />,
    ...
    },
    {
      ...
      icon: <ShieldAlert size={32} className="text-destructive animate-bounce" aria-hidden="true" />,
    ...
    },
    {
      ...
      icon: <BadgeCheck size={32} className="text-emerald-500 animate-pulse" aria-hidden="true" />,
    ...
    >
      <div className="bg-[#09090B] border border-border rounded-2xl w-full max-w-sm p-6 relative shadow-premium overflow-hidden text-center">
        ...
        <Button
          ...
          className="absolute top-4 right-4 h-8 w-8 text-muted-foreground hover:text-foreground rounded-lg focus-visible:ring-2 focus-visible:ring-primary"
        ...
        {/* Content */}
        <h3 id="tour-title" className="text-base font-bold text-foreground font-heading mb-2">
          {currentStepData.title}
        </h3>
        <p id="tour-desc" className="text-xs text-muted-foreground leading-relaxed px-2 mb-6">
        ...
        <div className="flex items-center justify-between mt-6">
          {/* Step circles */}
          <div className="flex items-center space-x-1.5" aria-label={`Step ${step} of 4`}>
            {[1, 2, 3, 4].map((s) => (
              <div
                key={s}
          ...
          {step < 4 ? (
            <Button
              ...
              className="h-8 text-xs font-semibold px-4 rounded-lg bg-primary text-primary-foreground hover:bg-primary/95 flex items-center cursor-pointer focus-visible:ring-2 focus-visible:ring-primary"
            >
              Next Step
            ...
            <Button
              onClick={handleComplete}
              className="h-8 text-xs font-semibold px-4 rounded-lg bg-gradient-to-r from-primary to-secondary text-white border-0 flex items-center cursor-pointer focus-visible:ring-2 focus-visible:ring-primary"
            >
              Get Started
              <Sparkles size={13} className="ml-1.5" aria-hidden="true" />
            </Button>
          )}
        </div>
      </div>
