    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <Link 
            href="/dashboard" 
            className="flex items-center space-x-2.5 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-lg p-1"
            aria-label="Privora Brand Home"
          >
          ...
          <Button
            ...
            className="hidden md:flex h-8 w-8 text-muted-foreground hover:text-foreground rounded-lg focus-visible:ring-2 focus-visible:ring-primary"
        ...
        {/* Navigation links */}
        <nav className="space-y-1.5 pt-4" aria-label="Dashboard Navigation">
              ...
              return (
                <li key={item.label}>
                  <Link
                    href={item.href}
                    className={cn(
                      "flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-card",
                      isActive
                  ...
                  >
                    <Icon size={18} className={cn(isActive && "text-primary")} aria-hidden="true" />
      ...
      <div className="space-y-4">
        ...
        <Button
          ...
          className={cn(
            "w-full text-muted-foreground hover:text-destructive hover:bg-destructive/5 rounded-lg justify-start px-3 cursor-pointer focus-visible:ring-2 focus-visible:ring-primary",
