    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 text-left">
        <div className="space-y-1.5">
          ...
          <Input
            ...
            disabled={isLoading}
            className={`bg-zinc-900 border-zinc-800 text-white placeholder-zinc-500 h-10 tracking-[0.5em] text-center text-lg focus-visible:ring-2 focus-visible:ring-primary ${
      ...
      <div className="text-center text-xs text-zinc-400 mt-4">
        ...
        <button
          ...
          className="text-primary hover:underline font-semibold bg-transparent border-0 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded px-1"
        >
          Resend Email
        </button>
      </div>
